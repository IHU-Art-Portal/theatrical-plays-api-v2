...
public class CuratorController : ControllerBase
{
    ...
    Dictionary<string, string> GetCorrectedRoleDictionary()
    {
        ...
        Dictionary<string, string> correctedRoleNames = new Dictionary<string, string>
        {
            ...
            { "βοηθοί σκηνοθέτη", "βοηθοί σκηνοθέτη"},
            ...
            { "", "κινηματογραφική σκηνοθεσία - μοντάζ"},
            { "", "κινηματογραφική σκηνοθεσία - μοντάζ"},
            { "", "κινηματογραφική σκηνοθεσία - μοντάζ"},
            ...
            { "βοηθός σκηνογράφου - ενδυματολόγου", "βοηθοί σκηνογράφου"},
            { "βοηθός σκηνογράφου & ενδυματολόγου", "βοηθοί σκηνογράφου"},
            { "βοηθός σκηνής", "βοηθοί σκηνής"},
            { "οδηγός σκηνής", "βοηθοί σκηνής"},
            ...
            { "", ""},
            { "η πρώτη του επαγγελματική του εμφάνιση ήταν στο έργο του ζ. φεϋντώ ράφτης κυριών (στο ρόλο του υπηρέτη ετιέν), το 1994. ακολούθησαν οι θεατρικές παρασ", "bad role"},
            { "τζαμσ", "???"},
            { "τζίμμυ", "???"},
            { "φοίβος", "???"},
            { "είδος", "???"},
